...
export default function JobTemplateSelector({ onSelectTemplate, onBack }: JobTemplateSelectorProps) {
                        ...
                        <Card key={template.id} className="cursor-pointer hover:shadow-md transition-shadow">
                            <CardHeader className="pb-3">
                                ...
                                <CardDescription className="text-sm">
                                    {template.roleDescription.length > 120
                                        ? `${template.roleDescription.substring(0, 120).trim()}...`
