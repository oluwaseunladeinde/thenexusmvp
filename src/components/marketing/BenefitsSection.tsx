            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {benefits.map((benefit) => (
                        <div key={benefit.title} className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="text-center mt-16">
                    <div className="bg-linear-to-r from-[#2E8B57] to-[#3ABF7A] rounded-lg p-8 text-white">
