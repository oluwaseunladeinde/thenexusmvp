        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
            <div className="p-4 border-b border-gray-100 dark:border-gray-600">
                <div className="flex items-center justify-between">
                    <h3 className="font-semibold text-[#0D1B2A] dark:text-gray-100">How HR Sees Your Profile</h3>
                    <Link
            ...
            <div className="p-4">
                ...
                {/* Top Skills */}
                <div className="mb-4">
                    <h5 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Top Skills</h5>
                ...
                {profileData?.verificationStatus === 'full' ? (
                    <div className="flex items-center gap-2 p-3 bg-green-50 dark:bg-green-950/50 border border-green-200 dark:border-green-800 rounded-lg">
                        ...
                        <span className="text-sm font-medium text-green-800 dark:text-green-200">Verified Professional</span>
                    </div>
                ) : (
                    <div className="flex items-center gap-2 p-3 bg-yellow-50 dark:bg-yellow-950/50 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                        <div className="flex-1">
                            <span className="text-sm font-medium text-yellow-800 dark:text-yellow-200">Complete verification to stand out</span>
                            <p className="text-xs text-yellow-700 dark:text-yellow-300 mt-1">Verified profiles get 65% more views</p>
                        </div>
                    </div>
                )}
            </div>
