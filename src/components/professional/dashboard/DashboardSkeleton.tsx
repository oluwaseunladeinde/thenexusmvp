                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div className="lg:col-span-1 space-y-4">
                        ...
                        <div className="bg-white rounded-lg shadow border border-gray-200">
                            <div className="p-6 text-center">
                                ...
                                <div className="h-4 bg-gray-200 rounded mx-auto mb-2 w-32 animate-pulse"></div>
                                <div className="h-3 bg-gray-200 rounded mx-auto mb-3 w-40 animate-pulse"></div>
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <div className="bg-white rounded-lg shadow border border-gray-200 p-6">
                            ...
                            <div className="h-3 bg-gray-200 rounded w-64 mb-4 animate-pulse"></div>
